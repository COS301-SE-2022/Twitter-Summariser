...
<details>
  ...
  <p>
    <h3> About Me: </h3>
      <h4>I am an eager and ambitious 20 year old, currently studying Computer Science at University of Pretoria (expecting to complete in Dec 2022), with a strong passion for technology and software, particularly with big data, data engineering, data science and machine learning. I am highly adaptive and believe anything can be accomplished with hard work and perseverance.</h4>
    <h3 align="left">Languages and Tools:</h3>
