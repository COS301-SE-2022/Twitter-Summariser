...
function LogoComponent({ page, width, height }: any) { // page is the page that the logo is being rendered on
  ...
  if(currentPage === "auth" || currentPage === "splash") { // if the page is an authentication page
    logoStyle = "pr-2";
  }
  else(currentPage === "landing") // if the page is the landing page
    logoStyle = "fixed 2xl:ml-14 lg:ml-3";

	return ( // return the logo based on set attributes
