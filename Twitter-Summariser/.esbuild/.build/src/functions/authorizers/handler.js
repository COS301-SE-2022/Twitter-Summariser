...
// src/functions/authorizers/handler.ts
var handler_exports = {};
...
dotenv.config();
function authorizationResponse(principalId, effect, arn) {
  return {
    principalId,
    policyDocument: {
      Version: "2012-10-17",
...
var verifyJWT = (event, _context, callback) => {
  ...
  try {
    ...
    const decoded = import_jsonwebtoken.default.verify(jwtToken, process.env.ACCESS_TOKEN_SECRET);
