                ...
                <div className="flex flex-row flex-wrap justify-around pt-3 pb-3 items-center">
					...
					>
                        ...
                        {loading && (
                            <button
                                type="button"
                                className="flex flex-row bg-dark-cornflower-blue rounded-full text-light-cyan2 group hover:shadow font-semibold button_large text-lg justify-center h-10 w-56 items-center"
                                disabled
                            >
                                {/* <svg
