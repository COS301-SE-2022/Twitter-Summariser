...
function TweetResponse({ position, type, type2, tweetId, DeleteIcon, done, data, reorderDownHandler, reorderUpHandler, ArrowDownIcon,ArrowUpIcon, deleteTweetHandler, color, sentimentValue, sentimentText }: any) {
