...
function MobileNotifications() {
    ...
    return (
        <div>
			<div  className="fixed flex w-16 h-16 lg:hidden rounded-full bg-midnight-blue justify-center items-center  bottom-8 right-8 cursor-pointer" onClick={toggling}>
